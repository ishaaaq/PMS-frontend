        ...
        <div className="max-w-4xl mx-auto space-y-8">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-500 text-sm">Create and issue formal reports for your projects.</p>
                </div>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
                {templates.map(t => (
                    ...
                    >
                        <div className={`h-10 w-10 rounded-full flex items-center justify-center mb-3 ${selectedTemplate === t.id ? 'bg-indigo-200 text-indigo-700' : 'bg-gray-100 text-gray-500'
                            }`}>
                            <FileText className="h-6 w-6" />
                        </div>
                        <h3 className={`font-bold text-sm mb-1 ${selectedTemplate === t.id ? 'text-indigo-900' : 'text-gray-900'}`}>
                            {t.name}
                        </h3>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="date" className="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500" />
                    </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-100 flex justify-end gap-3">
                    <button className="flex items-center px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 font-medium">

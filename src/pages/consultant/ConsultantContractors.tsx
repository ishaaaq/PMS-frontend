        ...
        <div className="max-w-6xl mx-auto space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <div className="relative">
                        ...
                        >
                            <option value="All Projects" disabled>Select Project</option>
                            {projects.map(p => (
            ...
            {loading ? (
                ...
                <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-1">No contractors found</h3>
                    <p className="text-gray-500 dark:text-gray-400 max-w-sm mx-auto mb-6">
                        {searchTerm ? 'Try adjusting your search terms.' : 'There are no contractors in this project.'}
                    </p>
                </div>
            )}

        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 glass-card p-6 rounded-2xl">
                    ...
                    <div className="h-64 relative flex items-end gap-2 px-2 border-b border-l border-gray-100 dark:border-gray-700">
                ...
                <div className="glass-card p-6 rounded-xl">
                    ...
                    <div className="space-y-4">
                        {riskAlerts.map(alert => (
                            <div key={alert.id} className="p-4 rounded-lg bg-gray-50 dark:bg-gray-800 border-l-4 transition-transform hover:scale-[1.02] cursor-pointer" style={{ borderColor: alert.intensity === 'High' ? '#ef4444' : alert.intensity === 'Medium' ? '#f59e0b' : '#3b82f6' }}>
                                <div className="flex justify-between items-start">
                                    <h4 className="font-bold text-sm text-gray-900 dark:text-white">{alert.project}</h4>
                                ...
                                <div className="mt-3 flex items-center justify-between">
                                    <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold uppercase ${alert.intensity === 'High' ? 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400' :
                            ...
                            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                {[
                                    ...
                                    <tr key={i} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors cursor-pointer">
                                        ...
                                        <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 font-bold">{c.count}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
